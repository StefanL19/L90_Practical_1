...
with multiprocessing.Pool(processes=multiprocessing.cpu_count()-1) as pool:
   pool.map(partial(count_word_occurences, vocab_length, pos_list, vocab), pos_docs_tokenized_train[:2])

print("Started iterating training negative documents")
with multiprocessing.Pool(processes=multiprocessing.cpu_count()-1) as pool:
   pool.map(partial(count_word_occurences, vocab_length, neg_list, vocab), neg_docs_tokenized_train[:2])
...
pos_train_df.to_csv('data/pos_train_val_1_test_0.csv', index=False, header=False)
...
neg_train_df.to_csv('data/neg_train_val_1_test_0.csv', index=False, header=False)
...
with multiprocessing.Pool(processes=multiprocessing.cpu_count()-1) as pool:
   pool.map(partial(count_word_occurences, vocab_length, pos_list_validation, vocab), pos_docs_tokenized_val[:2])

print("Started iterating validation negative documents")
with multiprocessing.Pool(processes=multiprocessing.cpu_count()-1) as pool:
   pool.map(partial(count_word_occurences, vocab_length, neg_list_validation, vocab), neg_docs_tokenized_val[:2])
...
pos_val_df.to_csv('data/pos_val_val_1_test_0.csv', index=False, header=False)
...
neg_val_df.to_csv('data/neg_val_val_1_test_0.csv', index=False, header=False)
...
with multiprocessing.Pool(processes=multiprocessing.cpu_count()-1) as pool:
   pool.map(partial(count_word_occurences, vocab_length, pos_list_test, vocab), pos_docs_tokenized_test[:2])

print("Started iterating test negative documents")
with multiprocessing.Pool(processes=multiprocessing.cpu_count()-1) as pool:
   pool.map(partial(count_word_occurences, vocab_length, neg_list_test, vocab), neg_docs_tokenized_test[:2])
...
pos_test_df.to_csv('data/pos_test_val_1_test_0.csv', index=False, header=False)
...
neg_test_df.to_csv('data/neg_test_val_1_test_0.csv', index=False, header=False)
