...
vocabulary, prior_pos, prior_neg, vocab_pos_freq, vocab_neg_freq = classifiers.train_multinomial_NB(pos_train, neg_train, True)
...
classifiers.apply_multinomial_NB(doc, vocabulary, prior_pos, prior_neg, vocab_pos_freq, vocab_neg_freq)
